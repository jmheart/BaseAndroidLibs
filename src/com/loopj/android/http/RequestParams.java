...
public class RequestParams {
	...
	private HttpEntity createMultipartEntity(
			AsyncHttpResponseHandler progressHandler) throws IOException {
	...
	private List<BasicNameValuePair> getParamsList(String key, Object value) {
		...
		if (value instanceof Map) {
			...
			for (String nestedKey : list) {
				...
				if (nestedValue != null) {
					params.addAll(getParamsList(key == null ? nestedKey
			...
			for (Object nestedValue : list) {
				params.addAll(getParamsList(String.format("%s[]", key),
						nestedValue));
			}
